  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-6">
        ...
        <p className="border-y py-4 text-center font-mono text-xs text-muted-foreground">
        ...
        {/* closing CTA */}
        <section className="my-14 rounded-2xl border bg-card px-6 py-10 text-center">
